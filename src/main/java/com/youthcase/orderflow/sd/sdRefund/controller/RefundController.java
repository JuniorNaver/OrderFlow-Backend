...
import com.youthcase.orderflow.sd.sdRefund.domain.*;
import com.youthcase.orderflow.sd.sdRefund.dto.*;
...
public class RefundController {
    ...
    public ResponseEntity<RefundResponse> refund(@RequestBody RefundRequest request) {
        log.info("💳 환불 요청 시작: paymentId={}, amount={}, reason={}",
                request.getPaymentId(), request.getCancelAmount(), request.getRefundReason());
        ...
        header.setDetailReason(request.getCardNo() != null ? request.getCardNo() : request.getDetailReason());
    ...
    public ResponseEntity<RefundResponse> getRefundDetail(@PathVariable Long refundId) {
        ...
        RefundResponse response = RefundResponse.builder()
                ...
                .reason(header.getRefundReason().name())
