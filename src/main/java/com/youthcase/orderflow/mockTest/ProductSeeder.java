    ...
    public void run(String... args) {
        ...
        for (Seed s : seeds) {
            ...
            var p = Product.builder()
                    ...
                    .orderable(s.orderable() != null ? s.orderable() : Boolean.TRUE)
                    .expiryType(ExpiryType.NONE)
                    .build();

            // ✅ 치수는 save 직전에 세팅
            if (s.shelfLifeDays() != null) {
                p.setShelfLifeDays(s.shelfLifeDays());
            }
            if (s.w() != null) p.setWidthMm(s.w());
            if (s.d() != null) p.setDepthMm(s.d());
            if (s.h() != null) p.setHeightMm(s.h());
